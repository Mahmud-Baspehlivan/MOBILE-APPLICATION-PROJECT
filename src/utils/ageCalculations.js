...
const AGE_GROUP_MAPPINGS = {
  "kilavuz-turkjmedsci": {
    ranges: [
      ...
      { max: 96, group: "5-8 years" },
      { max: 132, group: "8-11 years" },
      { max: 192, group: "11-16 years" },
  ...
  "kilavuz-tjp": {
    ranges: [
      ...
      { max: 120, group: "8-10 years" },
      { max: 144, group: "10-12 years" },
      { max: 168, group: "12-14 years" },
      { max: 192, group: "14-16 years" },
